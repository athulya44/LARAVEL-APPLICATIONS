...
Route::any('/frontendview', [App\Http\Controllers\frontendController::class, 'index'])->name('frontendview');
Route::get('/frontendshow/{id}', [App\Http\Controllers\frontendController::class, 'show'])->name('frontendshow');
